...
func _ready():
	# Устанавливаем видимость курсора один раз при открытии настроек
...
# Обрабатываем нажатие ESC для выхода в меню
func _input(event: InputEvent) -> void:
	# Используем стандартное действие "ui_cancel" (ESC по умолчанию)
	if event.is_action_pressed("ui_cancel"):
		# Возвращаемся в меню
		get_tree().change_scene_to_file("res://PlayerCharacter/UI/menu.tscn")
